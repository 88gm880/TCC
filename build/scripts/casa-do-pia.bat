...
set CLASSPATH=%APP_HOME%\lib\casa-do-pia.jar;%APP_HOME%\lib\mysql-connector-java-8.0.25.jar;%APP_HOME%\lib\javafx-fxml-16-win.jar;%APP_HOME%\lib\javafx-controls-16-win.jar;%APP_HOME%\lib\javafx-controls-16.jar;%APP_HOME%\lib\javafx-graphics-16-win.jar;%APP_HOME%\lib\javafx-graphics-16.jar;%APP_HOME%\lib\javafx-base-16-win.jar;%APP_HOME%\lib\javafx-base-16.jar;%APP_HOME%\lib\protobuf-java-3.11.4.jar

@rem Execute casa-do-pia
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CASA_DO_PIA_OPTS%  -classpath "%CLASSPATH%" org.openjfx.AppStarter %CMD_LINE_ARGS%
